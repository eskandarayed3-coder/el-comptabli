...
export const ACCOUNTING_GUIDES = {
  ...
  'plan-comptable': {
    ...
    intro: 'Le plan comptable tunisien classe tous les comptes en 7 grandes classes, chacune avec un numéro.',
    sections: [
    ...
    infographic: {
      type: 'table',
      headers: ['Classe', 'Contenu'],
      rows: [
        ['1', 'Comptes de capitaux'],
        ['2', 'Immobilisations'],
        ['3', 'Stocks'],
        ['4', 'Tiers (clients, fournisseurs, TVA)'],
        ['5', 'Trésorerie'],
        ['6', 'Charges'],
        ['7', 'Produits'],
      ],
